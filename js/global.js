...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (mediaModal && closeModalBtn) {
        ...
        const closeModal = () => {
            ...
            modalVideoPlayer.querySelector('source').setAttribute('src', '');
            modalImageViewer.setAttribute('src', '');
            modalYoutubePlayer.setAttribute('src', ''); // Clear YouTube src to stop playback
        };
    ...
    window.addEventListener('scroll', () => {
        ...
        // Offset to make sure the active link changes a bit before the section hits the very top
        ...
        navLinksList.forEach(link => {
            ...
            // Handle links to internal sections (e.g., #contact) and full page links
            ...
            if (href.includes('#') && href.substring(href.indexOf('#') + 1) === currentSectionId) {
                ...
                // Special handling for the current page link when no specific section is active
                // For example, on about.html, the "About Us" link should be active
                link.classList.add('active');
            }
            // For the home link, if we are on index.html and no other section is active
